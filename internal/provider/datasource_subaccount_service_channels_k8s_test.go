			...
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeAggregateTestCheckFunc(
						...
						resource.TestCheckResourceAttr("data.cloudconnector_subaccount_service_channels_k8s.cc_scs", "subaccount_service_channels_k8s.0.k8s_cluster", "cp.da2b3e1.stage.kyma.ondemand.com:443"),
						resource.TestCheckResourceAttr("data.cloudconnector_subaccount_service_channels_k8s.cc_scs", "subaccount_service_channels_k8s.0.k8s_service", "bd64665f-060a-47b6-8aba-f406703f0acf"),
						resource.TestCheckResourceAttr("data.cloudconnector_subaccount_service_channels_k8s.cc_scs", "subaccount_service_channels_k8s.0.port", "8080"),
						...
						resource.TestCheckResourceAttr("data.cloudconnector_subaccount_service_channels_k8s.cc_scs", "subaccount_service_channels_k8s.0.enabled", "true"),
						...
						resource.TestCheckResourceAttr("data.cloudconnector_subaccount_service_channels_k8s.cc_scs", "subaccount_service_channels_k8s.0.state.connected", "true"),
						...
						resource.TestCheckResourceAttr("data.cloudconnector_subaccount_service_channels_k8s.cc_scs", "subaccount_service_channels_k8s.0.state.opened_connections", "1"),
					),
				},
			},
		})
