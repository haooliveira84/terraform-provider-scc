			...
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeAggregateTestCheckFunc(
						...
						resource.TestCheckResourceAttr("data.scc_system_mappings.test", "system_mappings.0.local_host", "testterraforminternal"),
						resource.TestCheckResourceAttr("data.scc_system_mappings.test", "system_mappings.0.local_port", "900"),
